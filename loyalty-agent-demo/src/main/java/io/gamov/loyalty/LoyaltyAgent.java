...
@RegisterAiService(tools = NimbleTools.class)
@ApplicationScoped
public interface LoyaltyAgent {
  ...
  @SystemMessage("""
      ...
      3. If extractUrl returns 0 chars markdown, that page is gated by anti-bot. Pick a \
         different URL from the search results — but only ONE retry, then commit.
